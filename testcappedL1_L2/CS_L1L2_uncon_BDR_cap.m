function [z, output] = CS_L1L2_uncon_BDR_cap(A,b,pm,heuristic_on)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
gamma_0=min(1/ell,(sqrt(8*(2-nu)*ell^2)/(4*ell^2)))-(10^-10)-0.1;
gamma = gamma_0*ratio; 
...
for it = 1:maxit
    ...
    zn= prox_CapL1(2*xn-w+gamma*y,height_thres,lambda*gamma);
